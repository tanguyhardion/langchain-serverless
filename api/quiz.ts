...
3. Pour chaque paire :
   ...
   * Fournis **un extrait de l'article qui sert de contexte**, mais choisis un passage **relativement large ou général**. L'objectif est que l'utilisateur doive réfléchir et chercher l'information.
